      ...
      <div className="mt-16 flex flex-col items-center gap-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-4xl">
          <AnimateInView animation="animate-scale-in" className="animate-delay-1">
            <Link
              to="/book"
              className="group block bg-bg-card border border-white/10 rounded-2xl p-10 flex flex-col items-center text-center hover:border-red/40 transition-colors h-full"
            >
          ...
          <AnimateInView animation="animate-scale-in" className="animate-delay-1">
            <Link
              to="/quote"
              className="group block bg-bg-card border border-white/10 rounded-2xl p-10 flex flex-col items-center text-center hover:border-accent/40 transition-colors h-full"
            >
        ...
        <AnimateInView animation="animate-scale-in" className="animate-delay-2 w-full max-w-md">
          <Link
            to="/quick-pay"
            className="group block bg-bg-card border border-white/10 rounded-2xl p-8 flex flex-col items-center text-center hover:border-accent/40 transition-colors"
          >
