    ...
    <>
      ...
      <section className="max-w-7xl mx-auto px-6 py-24">
        <div className="max-w-3xl">
          <h2 className="text-3xl font-semibold text-black">Our story</h2>
          ...
          <p className="mt-4 text-black-muted/80 leading-relaxed">
      ...
      <section className="max-w-7xl mx-auto px-6 py-12">
        <div className="aspect-video max-h-[400px] w-full rounded-xl overflow-hidden bg-black/10">
      ...
      <section className="bg-cream-dark">
        <div className="max-w-7xl mx-auto px-6 py-24">
          <h2 className="text-3xl font-semibold text-black">How we work</h2>
          <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-12">
            <div>
              <h3 className="text-lg font-semibold text-black">Cinematic quality</h3>
              <p className="mt-3 text-black-muted/70 leading-relaxed text-sm">
            ...
            <div>
              <h3 className="text-lg font-semibold text-black">Reliable delivery</h3>
              <p className="mt-3 text-black-muted/70 leading-relaxed text-sm">
            ...
            <div>
              <h3 className="text-lg font-semibold text-black">Client-first approach</h3>
              <p className="mt-3 text-black-muted/70 leading-relaxed text-sm">
      ...
      <section className="max-w-7xl mx-auto px-6 py-24">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="aspect-square rounded-xl overflow-hidden bg-black/10">
            <video src={ABOUT_VIDEO} className="w-full h-full object-cover" muted loop playsInline autoPlay aria-hidden />
          </div>
          <div>
            <h2 className="text-3xl font-semibold text-black">Meet the pilot</h2>
            <p className="mt-4 text-black-muted/80 leading-relaxed">
